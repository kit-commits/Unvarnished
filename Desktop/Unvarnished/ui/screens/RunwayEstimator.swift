...
struct RunwayEstimator: View {
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 24) {
                ...
                VStack(spacing: 32) {
                    transactionRow(name: "Payroll Deposit", amount: "$2400", date: "Expected Friday")
                    transactionRow(name: "Freelance Invoice", amount: "$900", date: "Estimated 3-7 Days")
                    transactionRow(name: "Tax Refund", amount: "$650", date: "Processing")
                    transactionRow(name: "Marketplace Sale", amount: "$120", date: "Variable")
                }
    ...
    var walletCard: some View {
        VStack(spacing: 12) {
            ...
            HStack(spacing: 16) {
                runwayButton("Next Inflow", dark: false)
